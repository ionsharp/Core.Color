...
public struct WorkingProfile : IEquatable<WorkingProfile>
{
    ...
    public static ICompress DefaultCompression
        => new sRGBCompression();
    ...
    internal WorkingProfile(XYZ white, ICompress compression, Vector3<Vector2> position)
    {
        Compression = compression; Primary = position; White = white;
    }

    /// <summary>See <see cref="Default"/>.</summary>
    public WorkingProfile(Vector2 pR, Vector2 pG, Vector2 pB, Vector2 white, ICompress compression)
    {
        Compression = compression; Primary = new(pR, pG, pB); White = Illuminant.GetWhite(white);
    }
    ...
    public bool Equals(WorkingProfile i) => this.Equals<WorkingProfile>(i) && Compression == i.Compression && Primary == i.Primary && White.Value == i.White.Value;

    public override bool Equals(object i) => i is WorkingProfile j ? Equals(j) : false;

    public override int GetHashCode() => XArray.New<object>(Compression, Primary, White).GetHashCode();
    ...
    public static class Default
    {
        ...
        public static WorkingProfile NTSCJ
            => new(new(0.630, 0.340), new(0.310, 0.595), new(0.155, 0.070), Illuminant2.D93, DefaultCompression);
        ...
        public static WorkingProfile Rec601L5
            => new(new(0.630, 0.340), new(0.310, 0.595), new(0.155, 0.070), Illuminant2.D65, new Rec601Compression());

        /// <summary>Rec. 601 (625 lines)</summary><remarks><see cref="Illuminant2.D65"/></remarks>
        public static WorkingProfile Rec601L6
            => new(new(0.640, 0.330), new(0.290, 0.600), new(0.150, 0.060), Illuminant2.D65, new Rec601Compression());
        ...
        public static WorkingProfile Rec2100
            => new(new(0.708, 0.292), new(0.170, 0.797), new(0.131, 0.046), Illuminant2.D65, new Rec2100Compression());
        ...
        public static WorkingProfile scRGB
            => new(new(0.640, 0.330), new(0.300, 0.600), new(0.1500, 0.060), Illuminant2.D65, DefaultCompression);
        ...
        public static WorkingProfile sRGB 
            => new(DefaultPrimary.X, DefaultPrimary.Y, DefaultPrimary.Z, DefaultWhite, DefaultCompression);
